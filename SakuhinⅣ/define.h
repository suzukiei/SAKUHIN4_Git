...
//TITLE画面ボタン
#define TITLE_BUTTON_PLAY_WIDTH_POSITION			380		//プレイ画面遷移ボタン
#define TITLE_BUTTON_PLAY_HEIGHT_POSITION			380 
#define TITLE_BUTTON_LULE_TITLE_WIDTH_POSITION		370		 //ルール画面遷移ボタン
#define TITLE_BUTTON_LULE_TITLE_HEIGHT_POSITION		270 
#define TITLE_BUTTON_END_WIDTH_POSITION				370		 //終了ボタン
#define TITLE_BUTTON_ENDE_HEIGHT_POSITION			370 
